...
docker build -f Dockerfile \
  -t registry.digitalocean.com/geoffrey13-k8s/django-k8s-web:latest 
  -t registry.digitalocean.com/geoffrey13-k8s/django-k8s-web:v1 
```
...
5. Update Deployment `kubernetes/apps/django-k8s-web.yaml`:
...
- Image update:
```
kubectl set image deployment/django-k8s-web-deployment django-k8s-web=registry.digitalocean.com/geoffrey13-k8s/django-k8s-web:latest
```
...
Change 
```
image: registry.digitalocean.com/geoffrey13-k8s/django-k8s-web:latest
```
to
```
image: registry.digitalocean.com/geoffrey13-k8s/django-k8s-web:v1 
```
